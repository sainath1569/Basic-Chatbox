        ...
        <header className="chat-header">
          ...
          <div className="header-right">
            ...
            <button 
              ...
              title="Leave Chat"
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="leave-icon" style={{ width: "1rem", height: "1rem" }}>
